        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-400 mt-1">
              {users.length} users &middot; {users.filter((u) => u.status === 'active').length}{' '}
              active
            </p>
          </div>
          <button
