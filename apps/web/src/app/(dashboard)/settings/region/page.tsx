  ...
  return (
    <div style={{ padding: 32, maxWidth: 960 }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ color: 'var(--text-primary)', fontSize: 22, marginBottom: 4 }}>
          Region & Performance
        </h1>
          ...
          {REGIONS.map((r) => {
            ...
            return (
              ...
              >
                ...
                <td style={{ padding: 12, color: 'var(--text-primary)', fontSize: 13 }}>
                  {r.name}
                </td>
                ...
                <td
                  style={{ padding: 12, color, fontSize: 13, fontVariantNumeric: 'tabular-nums' }}
                >
                  {ms != null ? `${ms}ms` : '—'}
                </td>
                <td style={{ padding: 12 }}>
                ...
                <td style={{ padding: 12 }}>
                  ...
                  {isCurrent && (
                    <span style={{ fontSize: 11, color: 'var(--brand)' }}>● Current</span>
                  )}
                </td>
              </tr>
            );
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
          ...
          <h3 style={{ color: 'var(--text-primary)', fontSize: 14, margin: 0 }}>
            Data Residency & Compliance
          </h3>
        </div>
        <p style={{ color: 'var(--text-secondary)', fontSize: 12, lineHeight: 1.6, margin: 0 }}>
          EU regions (Ireland, Frankfurt) keep data within the EU for GDPR compliance. All regions
          are SOC 2 Type II and ISO 27001 certified.
        </p>
      </div>
    </div>
  );
