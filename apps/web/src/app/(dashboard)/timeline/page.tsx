...
export default function TimelinePage() {
  ...
  const handleSelectTake = useCallback((takeId: string) => {
    setMockTakes((prev) => prev.map((t) => ({ ...t, isActive: t.id === takeId })));
  }, []);
                        ...
                        return (
                          <div
                            ...
                            style={{
                              ...
                              opacity: isSelected
                                ? 1
                                : ((sStatus.opacity as number | undefined) ?? 0.85),
                              transition:
                                'opacity 120ms ease, border-color 120ms ease, box-shadow 200ms ease',
                              background: sStatus.background ?? clip.color,
                              ...sStatus,
                              ...(isSelected
                                ? {
                                    border: '2px solid #ffffff',
                                    boxShadow: `0 0 0 1px var(--brand), ${sStatus.boxShadow ?? ''}`,
                                  }
                                : {}),
                            }}
                          >
              ...
              {!selectedClip ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16, paddingTop: 12 }}>
                            ...
                            <X
                              ...
                              onClick={() =>
                                updateClip(selectedClip.id, {
                                  characters: (selectedClip.characters ?? []).filter(
                                    (c) => c !== char,
                                  ),
                                })
                              }
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                    ...
                    {generationState &&
                    generationState.clipId === selectedClip.id &&
                  ...
                  {(() => {
                    ...
                    const qualityScores = [
                      ...
                      },
                      {
                        ...
                        value:
                          generationState?.qualityScores?.fidelity != null
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12, paddingTop: 12 }}>
                  ...
                  {[
                    ...
                    },
                    {
                      label: 'Layer',
                      value:
                        tracks.find((t) => t.clips.some((c) => c.id === selectedClip.id))?.name ??
                        '---',
                    },
                    { label: 'Opacity', value: '100%' },
                    {
