...
const API_GROUPS: EndpointGroup[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'POST',
        path: '/v1/shots/:id/generate',
        description: 'Trigger generation for a shot',
      },
...
const SANDBOX_ENDPOINTS = API_GROUPS.flatMap((g) =>
  g.endpoints.map((e) => `${e.method} ${e.path}`),
);
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-xs text-gray-500 mt-0.5">
          API docs, SDKs, sandbox, and integration tools
        </p>
      </div>
            ...
            <div className="space-y-5">
              <div className={card}>
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Install the SDK and create your first animation in under 5 minutes.
                </p>
                <div className="rounded-lg bg-gray-950 border border-gray-800 p-4 overflow-x-auto">
                  <pre className="text-xs leading-relaxed">
                    <code className="text-gray-300">{QUICK_START}</code>
                  </pre>
                </div>
              </div>
              <div className={card}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  {[
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() =>
                        setActiveSection(r.title.toLowerCase().replace(/ /g, '-') as Section)
                      }
          ...
          {activeSection === 'authentication' && (
            <div className="space-y-5">
              <div className={card}>
                ...
                <div className="rounded-lg bg-gray-950 border border-gray-800 p-4 overflow-x-auto">
                  <pre className="text-xs leading-relaxed">
                    <code className="text-gray-300">{AUTH_EXAMPLE}</code>
                  </pre>
                </div>
              </div>
              <div className={card}>
                  ...
                  <div className="space-y-2">
                    {group.endpoints.map((ep, i) => (
                      <div key={i} className="flex items-center gap-3 p-3 rounded-lg bg-gray-800">
                        <span
                          className={`px-2 py-0.5 rounded text-[10px] font-bold border ${methodColor[ep.method]}`}
                        >
                          {ep.method}
                        </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {SDKS.map((sdk) => (
                <div key={sdk.name} className={card}>
                  ...
                  <code className="block text-[11px] text-gray-500 font-mono mb-4 bg-gray-800 rounded-lg px-3 py-2">
                    {sdk.lang}
                  </code>
          ...
          {activeSection === 'webhooks' && (
            <div className="space-y-5">
              <div className={card}>
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Receive real-time notifications when events occur in your account. Configure
                  webhook URLs in your account settings.
                </p>
                <div className="rounded-lg bg-gray-950 border border-gray-800 p-4 overflow-x-auto">
                  <pre className="text-xs leading-relaxed">
                    <code className="text-gray-300">{WEBHOOK_EXAMPLE}</code>
                  </pre>
                </div>
              </div>
            </div>
