...
const MOCK_ITEMS = [
  {
    ...
    description:
      'A fully detailed cyberpunk cityscape with neon lighting, rain effects, and animated billboards.',
  ...
  },
  {
    ...
    description:
      'Production-ready dragon character with full IK/FK rig, blend shapes, and 12 animation presets.',
  ...
  },
  {
    ...
    description:
      '20+ anime-style shaders with outline control, halftone shadows, and gradient ramp support.',
  ...
  },
  {
    ...
    description:
      'Physically-based water simulation effects including ocean, river, rain splash, and underwater caustics.',
  ...
  },
  {
    ...
    description:
      '30 hand-crafted medieval weapons with PBR textures at 4K resolution. Swords, axes, maces, and shields.',
  ...
  },
  {
    ...
    description:
      '50 professionally captured dance animations. Hip-hop, contemporary, ballet, and breakdance styles.',
