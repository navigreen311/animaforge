      ...
      shots: [
        {
          ...
          type: 'wide',
          description:
            'Sweeping establishing shot of the rain-soaked rooftop against a neon skyline.',
          duration: 5,
        ...
        },
        {
          ...
          type: 'close-up',
          description:
            "Kai's hand trembles as he lowers the weapon, realizing the rooftop is empty.",
          duration: 4,
    ...
    },
    {
      ...
      shots: [
        ...
        },
        {
          ...
          description:
            "Yuki manipulates holographic schematics; Zero's face flickers on screen behind her.",
          duration: 4,
          cameraMovement: 'static',
        },
        {
      ...
      shots: [
        {
          ...
          type: 'aerial',
          description:
            'Drone descends through morning mist, revealing the crumbling garden from above.',
          duration: 7,
          cameraMovement: 'crane-down',
        },
        {
          ...
          type: 'two-shot',
          description:
            'Kai and Yuki face each other at the pool, the bridge glowing between their hands.',
          duration: 5,
        ...
        },
        {
          ...
          type: 'long',
          description:
            'Lena steps from the trees as light breaks over the ruins. Hold wide as the three converge.',
          duration: 6,
          cameraMovement: 'static',
        },
      ],
