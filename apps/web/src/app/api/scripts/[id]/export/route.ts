  ...
  scenes: [
    {
      ...
      dialogue: [
        {
          character: 'KAI',
          parenthetical: '(into comms)',
          line: "I'm at the extraction point. No sign of the target.",
        },
      ],
    },
    {
      ...
      dialogue: [
        {
          ...
          line: "You're late. The neural bridge is destabilizing.",
        },
      ...
      dialogue: [
        {
          ...
          line: 'They remember everything. Every voice. Every footstep.',
        },
      ],
    },
  ],
