    ...
    endpoints: [
      ...
      },
      {
        ...
        requestExample: JSON.stringify(
          { title: 'My New Project', description: 'A stunning animation about...' },
          null,
          2,
        ),
        responseExample: JSON.stringify(
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        requestExample: JSON.stringify(
          { prompt: 'Updated shot prompt', duration_ms: 5000 },
          null,
          2,
        ),
        responseExample: JSON.stringify(
        ...
        requestExample: JSON.stringify(
          {
            ...
            type: 'humanoid',
            style: 'realistic',
            description: 'Tall figure with silver hair...',
          },
          null,
          2,
        ),
    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-500 mt-1">
          ...
          <code className="text-violet-400 bg-gray-800 px-1.5 py-0.5 rounded text-xs">
            https://api.animaforge.ai/v1
          </code>
        </p>
      </div>
