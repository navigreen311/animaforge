  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        <Globe size={13} />
        <span>
          {current?.flag} {current?.id}
        </span>
        {latencies[currentId] != null && (
          <span style={{ color: 'var(--text-tertiary)' }}>· {latencies[currentId]}ms</span>
        )}
      </button>
          ...
          {REGIONS.map((r) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ color, fontSize: 11, fontVariantNumeric: 'tabular-nums' }}>
                  {ms != null ? `${ms}ms` : '...'}
                </span>
