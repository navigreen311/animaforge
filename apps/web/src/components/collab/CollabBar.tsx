...
interface CollabBarProps {
  /** Connected users from useCollab awareness */
  users: CollabUser[];
  /** Whether the WebSocket is connected */
  isConnected: boolean;
  /** Project ID for generating invite links */
  projectId?: string;
}

/**
 * Displays connected user avatars, connection status, and share button.
 * Driven by Yjs awareness data from the useCollab hook.
 */
