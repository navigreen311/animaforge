  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-sm text-gray-400">Drop 1-3 reference photos here, or click to browse</p>
        <p className="mt-1 text-xs text-gray-500">{photos.length}/3 photos selected</p>
      </div>
