...
contextBridge.exposeInMainWorld('animaforge', {
  ...
  writeLocalFile: (filePath, data) => ipcRenderer.invoke('write-local-file', filePath, data),
  ...
  // Local AI / rendering
  getLocalModelPath: (modelId) => ipcRenderer.invoke('get-local-model-path', modelId),
  startLocalRender: (jobParams) => ipcRenderer.invoke('start-local-render', jobParams),
  getGPUInfo: () => ipcRenderer.invoke('get-gpu-info'),
  checkLocalModelCache: (modelId) => ipcRenderer.invoke('check-local-model-cache', modelId),
