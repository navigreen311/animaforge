...
| 19  | _Physics_        | AI API module           | --   | PBD cloth, hair, rigid body, and fluid simulation                  |
| 20  | _Training_       | AI API module           | --   | Custom model fine-tuning and LoRA training                         |
| 21  | _Cartoon Pro_    | AI API module           | --   | Stylized cartoon rendering (anime, watercolor, comic, 20+ styles)  |
| 22  | _MoCap_          | AI API module           | --   | Motion capture extraction from video input                         |
