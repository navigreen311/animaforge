...
describe('Consent Service', () => {
  ...
  describe('POST /api/v1/rights/consent', () => {
    ...
    it('should reject invalid input', async () => {
      const response = await request(app).post('/api/v1/rights/consent').send({ subject_id: '' });
  ...
  describe('DELETE /api/v1/rights/consent/:id', () => {
    it('should revoke an existing consent', async () => {
      ...
      const deleteRes = await request(app).delete(
        `/api/v1/rights/consent/${createRes.body.consent_id}`,
      );
    ...
    it('should return 404 for unknown consent id', async () => {
      const response = await request(app).delete('/api/v1/rights/consent/nonexistent-id');
