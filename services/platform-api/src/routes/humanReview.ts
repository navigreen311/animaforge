...
router.post('/review-queue/tasks', requireAuth, async (req: Request, res: Response) => {
...
router.put('/review-queue/tasks/:id/assign', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.put('/review-queue/tasks/:id/decision', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.put('/review-queue/tasks/:id/escalate', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.get('/review-queue/metrics', requireAuth, async (_req: Request, res: Response) => {
...
router.post('/review-queue/auto-assign', requireAuth, async (_req: Request, res: Response) => {
...
router.post('/support/tickets', requireAuth, async (req: Request, res: Response) => {
  ...
  if (!userId || !subject || !body || !category) {
    apiResponse.error(
      res,
      'VALIDATION_ERROR',
      'userId, subject, body, and category are required',
      400,
    );
    return;
  }
...
router.post('/support/tickets/:id/respond', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.put('/support/tickets/:id/close', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
