...
router.get('/receipts/summary', requireAuth, async (req: Request, res: Response) => {
  const userId = (req.query.userId as string) ?? req.user!.id;
...
router.get('/receipts/project/:projectId', requireAuth, async (req: Request, res: Response) => {
