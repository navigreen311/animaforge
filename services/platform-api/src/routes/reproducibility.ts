...
router.post('/reproducibility/snapshot', requireAuth, async (req: Request, res: Response) => {
...
router.get('/reproducibility/snapshot/:id', requireAuth, async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.post('/reproducibility/compare', requireAuth, async (req: Request, res: Response) => {
...
router.get('/reproducibility/lineage/:jobId', requireAuth, async (req: Request, res: Response) => {
