...
describe('POST /api/v1/characters', () => {
  it('should create a character and return 201', async () => {
    const res = await request(app).post('/api/v1/characters').send(validCharacter);
...
describe('GET /api/v1/characters/:id', () => {
  it('should return a character by id', async () => {
    const createRes = await request(app).post('/api/v1/characters').send(validCharacter);
  ...
  it('should return 404 for nonexistent character', async () => {
    const res = await request(app).get('/api/v1/characters/00000000-0000-0000-0000-000000000099');
...
describe('GET /api/v1/assets/search', () => {
  it('should search assets by name substring', async () => {
    ...
    const res = await request(app).get('/api/v1/assets/search').query({ q: 'splash' });
...
describe('DELETE /api/v1/assets/:id', () => {
  it('should delete an asset', async () => {
    const createRes = await request(app).post('/api/v1/assets').send(validAsset);
    const id = createRes.body.data.id;
