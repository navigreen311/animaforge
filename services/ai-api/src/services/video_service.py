...
def estimate_generation_time(tier: str, duration_ms: Optional[int] = None) -> float:
...
def calculate_credit_cost(tier: str, duration_ms: Optional[int] = None) -> float:
...
def create_video_job(params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    duration_ms: Optional[int] = params.get("duration_ms")
